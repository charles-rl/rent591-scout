...
`README.md` (hybrid proxy mode details), `IMPLEMENTATION_OUTLINE.md`, `docs/591research.md` (polling tiers §5), `docs/feedback-triage.md` (rating comments: deterministic-code vs dynamic-prompt routing; triage happens in-chat, not in `rate.py`).
